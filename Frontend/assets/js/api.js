...
const API = {
  ...
  sales: {
    ...
    completeSlot: (id, slotIndex, comboPriceId, slotId, itemId, sku, payload = null) =>
      http.post(`/api/v1/sales/${id}/complete-slot`, { slotIndex, comboPriceId, slotId, itemId, sku, payload }),
